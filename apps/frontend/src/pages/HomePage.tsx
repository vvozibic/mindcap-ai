          ...
          <div className="mt-12 bg-primary-800 rounded-lg shadow-lg p-6 border border-primary-700">
            ...
            <div className="prose max-w-none text-gray-300">
              <p>
                ...
                measures and applies "Attention Cap" for projects, creating a
                new paradigm for valuing influence.
              </p>
              <p className="mt-4">
                This initiative falls under the "Initial Attention Offering
                (IAO)," "InfoFi," and "Internet Capital Markets (ICM)"
                narratives, pioneering a new way to quantify and reward
                meaningful engagement in the Web3 space.
              </p>
            </div>
          </div>
        </div>
