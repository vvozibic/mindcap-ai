...
import { mockKOLs } from '../data/mockData';
  ...
  return [
    {
      ...
      description: 'Create a comprehensive video review of our platform highlighting key features and benefits. You will earn $2 for every 1000 views your content receives.',
      rewardType: 'cpm',
    ...
    },
    {
      ...
      description: 'Create an educational Twitter thread explaining how our technology works and its advantages.',
      rewardType: 'fixed',
      rewardAmount: 250,
      totalReward: 5000,
    ...
    },
    {
      ...
      description: 'Host an AMA session with your community about our project and its ecosystem.',
      rewardType: 'fixed',
      rewardAmount: 750,
      totalReward: 3000,
...
const getTopKOLsForProject = (projectId: string): KOL[] => {
...
const ProjectDetailOverlay: React.FC<ProjectDetailOverlayProps> = ({ 
  ...
  const handleEstimatedViewsChange = (e: React.ChangeEvent<HTMLInputElement>) => {
                ...
                {activeTab === 'overview' ? (
                  <div className="space-y-8">
                    ...
                    <div className="col-span-2">
                      <h5 className="text-lg font-medium text-gray-300 mb-3">Top KOLs Engaging with {project.name}</h5>
                      <div className="bg-primary-700 rounded-lg overflow-hidden">
                        <div className="p-4 bg-primary-600">
                          <h6 className="text-sm font-medium text-white">KOL Leaderboard</h6>
                        </div>
                          ...
                          <table className="min-w-full divide-y divide-primary-600">
                            <thead className="bg-primary-600">
                              <tr>
                                ...
                                <th scope="col" className="px-4 py-2 text-left text-xs font-medium text-gray-400 uppercase tracking-wider relative">
                            ...
                            <tbody className="divide-y divide-primary-600">
                              {topKOLs.map((kol, index) => (
                                <tr key={kol.id} className={index % 2 === 0 ? 'bg-primary-700' : 'bg-primary-600'}>
                                  <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-300">
                                    #{kol.rank}
                                  </td>
                                  <td className="px-4 py-2 whitespace-nowrap">
                                    <div className="flex items-center">
                                      <img className="h-6 w-6 rounded-full" src={kol.avatar} alt={kol.name} />
                                      <div className="ml-2">
                                        <div className="text-sm font-medium text-gray-200">{kol.name}</div>
                                        <div className="text-xs text-gray-400">{kol.handle}</div>
                                      </div>
                                    </div>
                                  </td>
                                  <td className="px-4 py-2 whitespace-nowrap text-sm text-gray-300">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-gray-200 mb-4">Project Information</h4>
                        ...
                        <div className="bg-primary-700 rounded-lg p-4 mb-6">
                          <div className="grid grid-cols-2 gap-4">
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                <h6 className="text-xs font-medium text-gray-400">Mindshare</h6>
                                <p className="text-lg font-bold text-gray-200">{project.mindshare}</p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                <h6 className="text-xs font-medium text-gray-400">Engagement Rate</h6>
                                <p className="text-lg font-bold text-gray-200">{project.engagementRate}%</p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                <h6 className="text-xs font-medium text-gray-400">KOL Attention</h6>
                                <p className="text-lg font-bold text-gray-200">{project.kolAttention}</p>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                <h6 className="text-xs font-medium text-gray-400">Trust Score</h6>
                                <p className="text-lg font-bold text-gray-200">{project.trustScore}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        
                        <h5 className="text-md font-medium text-gray-300 mb-3">About the Project</h5>
                        <div className="bg-primary-700 rounded-lg p-4 mb-6">
                          <p className="text-gray-300">
                            {project.name} is a leading Web3 project focused on building decentralized infrastructure for the next generation of applications. With a strong focus on security, scalability, and user experience, {project.name} is pushing the boundaries of what's possible in the blockchain space.
                          </p>
                        ...
                        <h5 className="text-md font-medium text-gray-300 mb-3">Social Channels</h5>
                        <div className="bg-primary-700 rounded-lg p-4">
                          <div className="grid grid-cols-2 gap-4">
                            <a href="#" className="flex items-center text-gray-300 hover:text-accent-500">
                      ...
                      <div>
                        <h4 className="text-lg font-medium text-gray-200 mb-4">Reward Pool</h4>
                        ...
                        <div className="bg-primary-700 rounded-lg p-6 mb-6 border border-primary-600">
                          <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center">
                              ...
                              <div className="ml-3">
                                <h5 className="text-sm font-medium text-gray-300">Total Reward Pool</h5>
                                <p className="text-3xl font-bold text-white">${project.rewardPool.toLocaleString()}</p>
                              </div>
                            </div>
                            <div className="bg-primary-800 rounded-lg p-3">
                              <p className="text-xs text-gray-400">Rank</p>
                              <p className="text-xl font-bold text-white">#{project.rank}</p>
                            </div>
                          </div>
                          
                          <div className="mt-6">
                            <h6 className="text-sm font-medium text-gray-300 mb-3">Active Campaigns</h6>
                            <div className="space-y-3">
                              {projectPools.filter(pool => pool.status === 'active').map(pool => (
                                <div key={pool.id} className="bg-primary-600 rounded-lg p-3 flex justify-between items-center">
                                  <div>
                          ...
                          <div className="mt-6 pt-6 border-t border-primary-600">
                            <h6 className="text-sm font-medium text-gray-300 mb-2">How It Works</h6>
                    ...
                    {selectedPool ? (
                      <div>
                        ...
                        <div className="bg-primary-700 rounded-lg p-6 mb-6 border border-primary-600">
                          <div className="flex justify-between items-start">
                            <div>
                              <h3 className="text-xl font-bold text-white">{selectedPool.title}</h3>
                              <div className="flex items-center mt-1">
                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                  selectedPool.status === 'active' ? 'bg-green-900 text-green-200' :
                                  selectedPool.status === 'upcoming' ? 'bg-blue-900 text-blue-200' :
                                  'bg-gray-700 text-gray-200'
                                }`}>
                                  {selectedPool.status === 'active' ? 'Active' : 
                                   selectedPool.status === 'upcoming' ? 'Upcoming' : 'Completed'}
                                </span>
                                <span className="ml-2 text-gray-400 text-sm">
                                  <Clock className="inline-block h-4 w-4 mr-1" />
                                  Deadline: {new Date(selectedPool.deadline).toLocaleDateString()}
                                </span>
                              </div>
                            </div>
                            <div className="text-right">
                              {selectedPool.rewardType === 'cpm' ? (
                                <div>
                                  ...
                                  <p className="text-2xl font-bold text-white">${selectedPool.rewardAmount}/1K views</p>
                                </div>
                              ) : (
                                <div>
                                  <p className="text-sm text-gray-400">Reward per submission</p>
                                  <p className="text-2xl font-bold text-white">${selectedPool.rewardAmount}</p>
                                </div>
                              )}
                            </div>
                          </div>
                          ...
                          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                              <h4 className="text-md font-medium text-gray-300 mb-2">Requirements</h4>
                              <ul className="list-disc list-inside text-gray-400 space-y-1">
                              ...
                              {selectedPool.rewardType === 'cpm' && (
                                <div className="mt-4 p-3 bg-primary-600 rounded-lg">
                                  <h5 className="text-sm font-medium text-gray-300 mb-2">Earnings Calculator</h5>
                                  ...
                                  <div className="flex justify-between text-sm">
                                    ...
                                    <span className="text-accent-500 font-medium">
                                      ${calculateEstimatedEarnings(estimatedViews, selectedPool.rewardAmount).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})}
                                    </span>
                                  </div>
                                </div>
                              )}
                            ...
                            <div>
                              <h4 className="text-md font-medium text-gray-300 mb-2">Platforms</h4>
                              ...
                              <div className="mt-4">
                                <h4 className="text-md font-medium text-gray-300 mb-2">Pool Status</h4>
                                <div className="bg-primary-600 rounded-lg p-3">
                                  <div className="flex justify-between text-sm mb-1">
                                    <span className="text-gray-400">Total Pool</span>
                                    <span className="text-white">${selectedPool.totalReward.toLocaleString()}</span>
                                  </div>
                                  <div className="flex justify-between text-sm mb-1">
                                    <span className="text-gray-400">Remaining</span>
                                    <span className="text-white">${selectedPool.remainingReward.toLocaleString()}</span>
                                  </div>
                                  <div className="flex justify-between text-sm">
                                    <span className="text-gray-400">Participants</span>
                                    <span className="text-white">{selectedPool.participantsCount} ({selectedPool.completedCount} completed)</span>
                                  </div>
                                  
                                  <div className="mt-3 w-full bg-primary-800 rounded-full h-2.5">
                                    <div 
                                      className="bg-accent-500 h-2.5 rounded-full" 
                                      style={{ width: `${(1 - selectedPool.remainingReward / selectedPool.totalReward) * 100}%` }}
                                    ></div>
                                  </div>
                                </div>
                                
                                {selectedPool.rewardType === 'cpm' && selectedPool.estimatedViews && (
                                  <div className="mt-3">
                                    <div className="flex justify-between text-xs text-gray-400">
                                      <span>Campaign Target</span>
                                      <span>{selectedPool.estimatedViews.toLocaleString()} views</span>
                                    </div>
                                  </div>
                                )}
                              </div>
                          ...
                          {isAuthenticated ? (
                            isSubmitting ? (
                              <div className="mt-6 pt-6 border-t border-primary-600">
                                <h4 className="text-md font-medium text-gray-300 mb-4">Submit Your Content</h4>
                                
                                <div className="space-y-4">
                                  <div>
                                    <label htmlFor="contentUrl" className="block text-sm font-medium text-gray-300 mb-1">
                                    ...
                                    <p className="mt-1 text-xs text-gray-400">
                                      Paste the URL to your content (YouTube video, Twitter thread, etc.)
                                    </p>
                                  </div>
                                  ...
                                  <div className="flex justify-end space-x-3">
                                    ...
                                    <button
                                      ...
                                      className={`px-4 py-2 rounded-md text-primary-900 ${
                                        submissionUrl.trim() ? 'bg-accent-500 hover:bg-accent-600' : 'bg-accent-500 opacity-50 cursor-not-allowed'
                                      }`}
                                    >
                                      Submit Content
                                    </button>
                              ...
                              <div className="mt-6 pt-6 border-t border-primary-600 flex justify-between items-center">
                                <div>
                                  <h4 className="text-md font-medium text-gray-300">Ready to participate?</h4>
                            ...
                            <div className="mt-6 pt-6 border-t border-primary-600">
                              <div className="bg-primary-600 p-4 rounded-lg text-center">
                                <h4 className="text-md font-medium text-gray-300 mb-2">Sign in to participate</h4>
                                <p className="text-sm text-gray-400 mb-4">
                                  You need to sign in to submit content and earn rewards from this project pool.
                                </p>
                                <button
                                  onClick={onLogin}
                      ...
                      <div>
                        <div className="flex justify-between items-center mb-6">
                          <h3 className="text-xl font-bold text-white">Available Project Pools</h3>
                          <div className="text-right">
                            <p className="text-sm text-gray-400">Total Reward Pool</p>
                            <p className="text-2xl font-bold text-white">${project.rewardPool.toLocaleString()}</p>
                          </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          {projectPools.map(pool => (
                            ...
                            >
                              <div className="flex justify-between items-start">
                                <h4 className="text-lg font-medium text-white">{pool.title}</h4>
                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                                  pool.status === 'active' ? 'bg-green-900 text-green-200' :
                                  pool.status === 'upcoming' ? 'bg-blue-900 text-blue-200' :
                                  'bg-gray-700 text-gray-200'
                                }`}>
                                  {pool.status === 'active' ? 'Active' : 
                                   pool.status === 'upcoming' ? 'Upcoming' : 'Completed'}
                                </span>
                              </div>
                              
                              <p className="mt-2 text-gray-400 text-sm line-clamp-2">{pool.description}</p>
                              ...
                              <div className="mt-4 flex items-center justify-between">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-300">{new Date(pool.deadline).toLocaleDateString()}</p>
                                </div>
                                <div>
                              ...
                              <div className="mt-4">
                                <div className="flex justify-between text-xs text-gray-400 mb-1">
                                  ...
                                  <span>${pool.remainingReward.toLocaleString()} remaining</span>
                                </div>
                                <div className="w-full bg-primary-800 rounded-full h-2">
                                  <div 
                                    className="bg-accent-500 h-2 rounded-full" 
                                    style={{ width: `${(1 - pool.remainingReward / pool.totalReward) * 100}%` }}
                                  ></div>
                                </div>
                              </div>
                            </div>
                        ...
                        {!isAuthenticated && (
                          <div className="mt-8 bg-primary-700 p-5 rounded-lg border border-primary-600 text-center">
                            <h4 className="text-lg font-medium text-white mb-2">Want to participate and earn rewards?</h4>
                            <p className="text-gray-400 mb-4">
                              Sign in to submit content and earn rewards from project pools.
                            </p>
                            <button
                              onClick={onLogin}
