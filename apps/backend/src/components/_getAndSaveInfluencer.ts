  ...
  try {
    ...
    await prisma.influencer.upsert({
      ...
      update: {
        ...
        tweetsCountNumeric: data.tweets_count,
        followersCountNumeric: data.followers_count,
        followingsNumeric: data.friends_count,
      ...
      create: {
        ...
        platform: "twitter",
        verified: data.verified,
        tweetsCount: String(data.tweets_count),
        followersCount: String(data.followers_count),
        followings: String(data.friends_count),
        tweetsCountNumeric: data.tweets_count,
        followersCountNumeric: data.followers_count,
        followingsNumeric: data.friends_count,
